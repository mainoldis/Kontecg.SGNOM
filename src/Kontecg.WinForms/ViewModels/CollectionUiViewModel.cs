...
{
    public class CollectionUiViewModel : KontecgViewModelBase
    {
        /// <inheritdoc />
        public CollectionUiViewModel()
        {
        ...
        private void RaiseViewKindChanged()
        {
            ViewKindChanged?.Invoke(this, EventArgs.Empty);
        }

        private void RaiseViewLayoutChanged()
        {
            ViewLayoutChanged?.Invoke(this, EventArgs.Empty);
        }
        ...
        public bool IsDetailHidden => ViewLayout == CollectionViewMasterDetailLayout.DetailHidden;

        public bool IsHorizontalLayout => ViewLayout == CollectionViewMasterDetailLayout.Horizontal;
