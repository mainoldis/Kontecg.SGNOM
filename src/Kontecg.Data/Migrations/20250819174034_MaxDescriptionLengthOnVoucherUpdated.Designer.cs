...
namespace Kontecg.Migrations
{
    ...
    [Migration("20250819174034_MaxDescriptionLengthOnVoucherUpdated")]
    partial class MaxDescriptionLengthOnVoucherUpdated
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DocumentDefinitionViewName", b =>
                {
                    ...
                    b.HasKey("DocumentsId", "ViewsId");

                    b.HasIndex("ViewsId");

                    b.ToTable("document_views", "cnt");
                });
            ...
            modelBuilder.Entity("Kontecg.Accounting.AccountingDocument", b =>
                {
                    ...
                    b.HasIndex("CompanyId", "PeriodId", "DocumentDefinitionId");
            ...
            modelBuilder.Entity("Kontecg.Accounting.ViewName", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("view_names", "cnt");
                });

            modelBuilder.Entity("Kontecg.Accounting.ViewNameResultRecord", b =>
                {
                    b.Property<decimal?>("AporteFuerzaLaboral")
                        .HasPrecision(28, 24)
                        .HasColumnType("decimal(28,24)");

                    b.Property<decimal?>("AporteSegSoc")
                        .HasPrecision(28, 24)
                        .HasColumnType("decimal(28,24)");
                    ...
                    b.Property<decimal?>("ImpVac")
                        .HasPrecision(28, 24)
                        .HasColumnType("decimal(28,24)");

                    b.Property<bool?>("Jornalero")
                        .HasColumnType("bit");

                    b.Property<decimal?>("ProvisionSegSoc")
                        .HasPrecision(28, 24)
                        .HasColumnType("decimal(28,24)");
            ...
            modelBuilder.Entity("Kontecg.Organizations.WorkPlaceResponsibility", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("workplace_responsibilities", "est");
                });
            ...
            modelBuilder.Entity("DocumentDefinitionViewName", b =>
                {
                    b.HasOne("Kontecg.Workflows.DocumentDefinition", null)
                        .WithMany()
                        .HasForeignKey("DocumentsId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Kontecg.Accounting.ViewName", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Kontecg.Accounting.AccountingDocument", b =>
                {
                    ...
                    b.HasOne("Kontecg.Timing.Period", "Period")
                        .WithMany()
            ...
            modelBuilder.Entity("Kontecg.HumanResources.Person", b =>
                {
                    ...
                    b.OwnsOne("Kontecg.HumanResources.Address", "OfficialAddress", b1 =>
                        {
                            b1.Property<long>("PersonId")
                                .HasColumnType("bigint");
