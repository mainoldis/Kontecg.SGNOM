...
namespace Kontecg.Authorization.Roles
{
    ...
    /// </summary>
    [KontecgAuthorize(PermissionNames.AdministrationRoles)]
    public class RoleAppService : KontecgAppServiceBase, IRoleAppService
    {
        ...
        [KontecgAuthorize(PermissionNames.AdministrationRolesCreate,
            PermissionNames.AdministrationRolesEdit)]
        ...
        [KontecgAuthorize(PermissionNames.AdministrationRolesDelete)]
        ...
        [KontecgAuthorize(PermissionNames.AdministrationRolesEdit)]
        ...
        {
            var role = new Role(KontecgSession.CompanyId, input.Role.DisplayName) {IsDefault = input.Role.IsDefault};
