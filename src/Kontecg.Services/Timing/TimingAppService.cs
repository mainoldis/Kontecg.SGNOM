...
{
    public class TimingAppService : KontecgAppServiceBase, ITimingAppService
    {
        ...
        private async Task<List<NameValueDto>> GetTimezoneInfos(SettingScopes defaultTimezoneScope)
        {
            var defaultTimezoneId =
                await _timeZoneService.GetDefaultTimezoneAsync(defaultTimezoneScope, KontecgSession.CompanyId);
