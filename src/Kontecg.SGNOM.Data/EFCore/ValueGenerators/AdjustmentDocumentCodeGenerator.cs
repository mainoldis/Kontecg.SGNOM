...
{
    /// <summary>  
    /// Generates unique codes for AdjustmentDocument entities based on the year and existing codes.  
    /// </summary>  
    public class AdjustmentDocumentCodeGenerator : ValueGenerator<string>
    {
        /// <inheritdoc />  
        ...
        /// <summary>  
        /// Retrieves the maximum code value for AdjustmentDocument entities in the current transaction.  
        /// </summary>  
        ...
        protected virtual string GetMaxCodeInTransaction(DbContext context, string year)
        {
            ...
            var maxDbCode = context.Set<AdjustmentDocument>()
                                   .AsNoTracking()
            ...
            var pendingMax = context.ChangeTracker.Entries<AdjustmentDocument>()
