...
{
    /// <summary>  
    /// Generates unique codes for ClaimDocument entities based on the year and existing codes.  
    /// </summary>  
    public class ClaimDocumentCodeGenerator : ValueGenerator<string>
    {
        /// <inheritdoc />  
        ...
        /// <summary>  
        /// Retrieves the maximum code value for ClaimDocument entities in the current transaction.  
        /// </summary>  
        ...
        protected virtual string GetMaxCodeInTransaction(DbContext context, string year)
        {
            ...
            var maxDbCode = context.Set<ClaimDocument>()
                                   .AsNoTracking()
            ...
            var pendingMax = context.ChangeTracker.Entries<ClaimDocument>()
